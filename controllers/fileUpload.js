...
exports.imageUpload = async (req, res) => {
    try{
        ...
        console.log("Uploading to KalpFile");
        const response = await uploadFileToCloudinary(file, "KalpFile");
...
exports.imageSizeReducer = async (req,res) => {
    try{
        ...
        const response = await uploadFileToCloudinary(file, "KalpFile", 90);
        console.log(response);
